...
1. Create a tag with the new version number: `git tag VERSION_NUMBER`
...
1. [Create a new release](https://github.com/guidokessels/xwing-data2/releases/new) on GitHub and use the following:
   ...
   - `Describe this release`: The output of the `yarn run changelog PREVIOUS_TAG...NEW_TAG` command
1. :tada: !
